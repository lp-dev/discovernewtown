 					...
 					echo "
							...
							<div class=\"media\">
								...
								<div class=\"media-body\">
									...
									<p>Mon - Wed: 9:30am - 6:30pm</p>
									<p>Thu - Fri: 9:30am - 7:30pm</p>
									<p>Sat: 9:30pm - 6:00pm</p>
								</div>
							</div>
						...
						<div class=\"col-md-6 middlebtmpad\" id=\"col2\">
							...
							<div id=\"carouselpremium\" class=\"carousel slide\" data-ride=\"carousel\">
							  ...
							  <div class=\"carousel-inner\" role=\"listbox\">
							    ...
							    <div class=\"item\">
							      <img src=\"../" . $row ['Folder'] . "/slide2.jpg\" alt=\"slide2\">
							      <div class=\"carousel-caption\">
								    <h4>" . $caption2 . "</h4>
								    <p>" . $subcaption2 . "</p>
								  </div>
							    ...
							    <div class=\"item\">
							      <img src=\"../" . $row ['Folder'] . "/slide3.jpg\" alt=\"slide3\">
							      <div class=\"carousel-caption\">
								    <h4>" . $caption3 . "</h4>
								    <p>" . $subcaption3 . "</p>
								  </div>
