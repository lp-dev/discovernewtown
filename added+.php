...
<?php
        ...
        $query = "INSERT INTO dnlistings (Active, Premium, Name, Address, Phone, Email, Website, Facebook, Extras, Category, SDescription, LDescription, Filters, TC, Summary, Searches) VALUES ('no','yes','$businessname','$address','$businessphone','$businessemail','$website','$faceb','$extralinks','$category','$shortdescription','$longdescription','$subcategory, $type, $cost, $extras, $features','$agree','$businessname, $address, $businessphone, $businessemail','$businessname, $address, $subcategory, $type, $cost, $extras, $features')";
        ...
        //mail('contact@discovernewtown.co.nz', 'Discover Newtown Premium Sign Up', 'Contact name: ' . $contactname . ". \n" . 'Contact phone: ' . $contactphone . ". \n" . 'Contact mobile: ' . $contactmobile . ". \n" . 'Contact email: ' . $contactemail . ". \n" . 'Business name: ' . $businessname . ". \n" . 'Street address: ' . $address . ". \n" . 'Business phone: ' . $businessphone . ". \n" . 'Business email: ' . $businessemail . ". \n" . 'Category: ' . $category . ". \n" . 'Subcategory: ' . $subcategory . ". \n" . 'Type: ' . $type . ". \n" . 'Cost: ' . $cost . ". \n" . 'Extras: ' . $extras . ". \n" . 'Features: ' . $features . ". \n" . 'Website: ' . $website . ". \n" . 'Facebook: ' . $faceb . ". \n" . 'Extra links: ' . $extralinks . ". \n" . 'Short description: ' . $shortdescription . ". \n" . 'Long description: ' . $longdescription . ". \n" . 'Extra message: ' . $extramessage . ". \n" . 'Upgrade to premium: ' . $addpremium . ". \n" . 'Build a website: ' . $buildwebsite . ". \n" . 'Build a Facebook page: ' . $buildfacebook . ". \n" . 'Agreed to T&Cs: ' . $agree . ".", 'From: contact@discovernewtown.co.nz');
        mail('contact@discovernewtown.co.nz', 'Discover Newtown Premium Sign Up', 'Contact name: ' . $contactname . ". \n" . 'Contact phone: ' . $contactphone . ". \n" . 'Contact mobile: ' . $contactmobile . ". \n" . 'Contact email: ' . $contactemail . ". \n" . 'Business name: ' . $businessname . ". \n" . 'Street address: ' . $address . ". \n" . 'Business phone: ' . $businessphone . ". \n" . 'Business email: ' . $businessemail . ". \n" . 'Category: ' . $category . ". \n" . 'Subcategory: ' . $subcategory . ". \n" . 'Type: ' . $type . ". \n" . 'Cost: ' . $cost . ". \n" . 'Extras: ' . $extras . ". \n" . 'Features: ' . $features . ". \n" . 'Website: ' . $website . ". \n" . 'Facebook: ' . $faceb . ". \n" . 'Extra links: ' . $extralinks . ". \n" . 'Short description: ' . $shortdescription . ". \n" . 'Long description: ' . $longdescription . ". \n" . 'Agreed to T&Cs: ' . $agree . ".", 'From: contact@discovernewtown.co.nz');
