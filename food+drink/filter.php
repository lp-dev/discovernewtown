<?php include '../headerp.php'; ?>
    ...
    <div class="container conmarg">
	  ...
	  <div class="col-md-3 middlebtmpad" id="col1">
        ...
        <a  href="../food+drink"><button type="button" class="btn btn-default headerelement stretch"><img class="filterimg" src="../img/menu/f.png" alt="filter"></img>Food & Drink</button></a>
      </div>
				...
				<div id='food+drinkfilter'>
				    ...
				    <div class="col-md-12">
				        ...
				        <div class="col-md-6">
				            ...
				            <input type='checkbox' name="filters[]" value="Convenience store Dairy" id="ConveniencestoreDairy"> Convenience Store / Dairy</input><br>
