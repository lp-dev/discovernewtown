        ...
        <div class="panel panel-default catmenu hidemenu">
            <div class="btn-group-vertical" role="group" aria-label="...">
                ...
                <a href="medical"><button type="button" class="btn btn-default buttonmenu"><img class="menuimg" src="img/menu/m.png" alt="M">Medical</img></button></a>
                <a href="retail+shopping"><button type="button" class="btn btn-default buttonmenu"><img class="menuimg" src="img/menu/r.png" alt="R">Retail & Shopping</img></button></a>
                <a href="sports+recreation"><button type="button" class="btn btn-default buttonmenu"><img class="menuimg" src="img/menu/s.png" alt="S">Sports & Recreation</img></button></a>
                <a href="trades+services"><button type="button" class="btn btn-default buttonmenu"><img class="menuimg" src="img/menu/t.png" alt="T">Trades & Services</img></button></a>
                <a href="other"><button type="button" class="btn btn-default buttonmenu"><img class="menuimg" src="img/menu/other.png" alt="...">Other</img></button></a>
            </div>
        </div>